...
> Mcdonald 모방 프로젝트로 메뉴, 매장, 배달 가능 여부, 진행하는 이벤트 조회와  음식 주문, 회사 소개 페이지로 이루어진 메인 페이지를 제작하고 메뉴,배너,이벤트,주문,사용자 등 사이트를 관리할 수 있는 관리자 페이지를 추가로 제작 해봤습니다.
...
- 관리자 페이지
  - 메뉴, 매장, 이벤트, 회사소개, faq, 주문, 배너, 옵션, 슬라이드 CRUD 관리 기능
  - 인기상품, 매출 추이 등 차트로 확인  
  - 관리자 페이지 사용설명서 다운로드
- 메뉴 주문 기능 & 주문시 토스페이먼츠 API 사용해 결제 기능 구현 
- 주소 API 활용해 배달 가능 여부 확인 기능
- 카카오 맵 API 매장 지도 검색 서비스
- 메뉴 주문시 토스페이먼츠 API 사용해 결제 기능 구현 
- 마이페이지에서 기간별 주문 조회 기능
...
1. 웹 서비스의 최종적인 메인 기능과 서브 기능 설명
   ...
   1. 메뉴
    ...
    10. 관리자 페이지 (페이지 하단 footer에 관리자 페이지 버튼)
...
* Admin : 페이지 관리 페이지 (페이지 하단 footer에 관리자 페이지 버튼)
* payment : 상품 결제 페이지
<br/><br/>
#### 🧩 back-end
<br/>
